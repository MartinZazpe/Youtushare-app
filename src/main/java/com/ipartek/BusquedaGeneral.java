...
@WebServlet("/BusquedaGeneral")
public class BusquedaGeneral extends HttpServlet  implements DAO_Constantes{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("usuario_id") != null) {
			...
			if(session.getAttribute("usuario_name") != null
					...
					session.getAttribute("usuario_rol").equals("admin")
					) {
	      ...
	      List<V_Cancion> busquedaGeneralResp = db.busquedaGeneral(con, searchText);
	       ...
	       // paso 6 mochila
	   		request.setAttribute("atr_lista_canciones", busquedaGeneralResp);	
	   		
	   		
	   		
	  
	   	  ruta = VISTA_BUSQUEDAGENERAL;
			}
