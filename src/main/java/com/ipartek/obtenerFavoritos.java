...
@WebServlet("/obtenerFavoritos")
public class obtenerFavoritos extends HttpServlet implements DAO_Constantes {
	...
	String ruta = VISTA_INICIO;
	 ...
	 //Check that the user in session still exists in db.
      ...
      List<V_favoritas> todasCancionesFavsRs = db.obtenerFavoritasCanciones(con, userId);
       ...
       System.out.println("resultado de obtener favoritas: " + todasCancionesFavsRs);
